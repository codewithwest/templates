...
<head>
   ...
   <link rel="stylesheet" href="<?php echo e(asset('css/const.css')); ?>">
    ...
    <main class="main">
                ...
                <button class="collapse-cart  b-none bg-none">X</button>
                 ...
                 <div class="checkout-form-cont fill center-content">
                    <form class="checkout-form flex-col j-sa" action="https://sandbox.payfast.co.za/eng/process" method="post" >
                        ...
                        <input type="text" name="email_address" required></div>
                        <div  class="j-sa">
                         <label for="address">Address</label>    
                        <input type="text" name="address" required></div>
                         <div  class="j-sa">
                          <label for="cell_number">Phone</label>   
                         <input type="phone" name="cell_number" required></div>
        ...
        <div class="reg-bg fill d-none center-content text-bg d-none">
                ...
                <h1 class="text-center">REGISTER</h1>
                    <input class="name m-auto center-content" type="text" name="name" placeholder="Name">
                    <input class="reg-email m-auto" type="text" name="email" placeholder="Email">
                    <input class="reg-password m-auto" type="text" name="password" placeholder="Password">
                    <input class="password-confirm m-auto" type="text" name="confirm" placeholder="Confirm Password">
        ...
        <div  class="login-bg fill center-content text-bg">
                <form class="login-form flex-col">
                    ...
                    <input class="m-auto" type="email" name="email" placeholder="email">
                    <input class="login-password m-auto" type="password" name="password" placeholder="password">
        ...
        <div class="profile-cont center-content fill test-bg">
            <div class="profile">
                ...
                <form  class="update-det flex-col j-sb"> 
                    <?php echo csrf_field(); ?>
                <input class="b-none" type="text" name="name" value="<?php echo e(request()->session()->get('name')); ?>">
                <input class="b-none" type="text" email="email" value="<?php echo e(request()->session()->get('email')); ?>">
                <input class="b-none" type="text" disabled="password" placeholder="password"  
                value="<?php echo e(request()->session()->get('password')); ?>">
        ...
        <nav class="nav">
            <div class="logo-cart">
                <div class="logo-cont center-content">
                    <img class="fill" src="<?php echo e(asset('images/logo.jpg')); ?>" alt="" srcset="">
                </div>
                ...
                <p class="email-init d-none"> <?php echo e(request()->session()->get('email')); ?></p>
        ...
        <div class="min-nav">
            ...
            <!-- Image Logo -->
            <div class="img-bg  ">
                <img class="fill" src="<?php echo e(asset('images/logo.jpg')); ?>" alt="">
            </div>            
            <!-- Collapse nav -->
            <div class="nav-col">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="second-batch-card flex-col  text-center center-content">
                            ...
                            <div class="second-batch-main-card flex-col h-100">
                                    <div class="sec-batch-img d-flex"><img src="" class='fill'></div>
                                    <div class="brand m-auto">Brand:<?php echo e($data->name); ?> </div>
                                    <div class="title center-content text-center"><?php echo e($data->desc); ?></div>
                                    <div class="ratings j-sa" ><p class="d-none"><?php echo e($data->rating); ?></p ></div>
                                    <div class="reviews text-center"></div>
                                    <div class="cost text-center"><?php echo e($data->price); ?></div>
                                    <div class="add-cart center-content text-center">
                                        <button class="add-btn d-flex">
                                            <p class="d-none"><?php echo e($data->id); ?></p>
                                    ...
                                    <div class="state text-center"><?php echo e($data->availability); ?></div>
                            </div>
                            </div>
                    <!-- End of Card -->
                        ...
                        <div class='d-flex'>
                            <div class="con con-3 m-auto d-flex">
                                <div class="left-img-icon  h-100">
                                    <img class="fill" src="/images/featured/fp9.jpeg" alt=""></div>
...
<script src="<?php echo e(asset('js/nav.js')); ?>" type="module"></script>
<script src="<?php echo e(asset('js/firstBatch.js')); ?>" type="module"></script>
<script src="<?php echo e(asset('js/footProd.js')); ?>" type="module"></script>
<script src="<?php echo e(asset('js/auth.js')); ?>" type="module"></script>
<script src="<?php echo e(asset('js/auth-manager.js')); ?>" type="module"></script>
<script src="<?php echo e(asset('js/cart-manager.js')); ?>" type="module"></script>
<script src="<?php echo e(asset('js/login.js')); ?>" type="module"></script>
</html>
<?php /**PATH C:\xampp\htdocs\creedsy\resources\views/index.blade.php ENDPATH**/ ?>