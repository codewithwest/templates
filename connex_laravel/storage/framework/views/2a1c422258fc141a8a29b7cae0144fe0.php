...
<head>
    ...
    <title>Admin</title>
       <link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/prod.css')); ?>">
</head>
<body>
    <main class="main">
        <!-- Start of nav -->
        ...
        <section class="prod-sec">
            ...
            <div class="prod-bg fill d-none center-content text-bg">
                <form class="prod-form center-content flex-col">
                <?php echo csrf_field(); ?>   
        ...
        <!-- Update Product -->
            <div class="upd-prod-bg fill center-content text-bg ">
                <form class="edit-form center-content flex-col">
        ...
        <div class="table-caption m-auto-hor center-content">
            Products Inventory
        </div>
        <!-- Table Start -->
            <table class="table m-auto-hor">
                <th>Id</th>
                <th>Brand</th>
                <th>Desc</th>
                <th>Price</th>
                ...
                <tr class="text-center">
                    <td class="brand m-auto"><?php echo e($data->id); ?></td>
                    <td class="brand m-auto"><?php echo e($data->name); ?></td>
                    <td class="brand m-auto"><?php echo e($data->desc); ?></td>
                    <td class="brand m-auto"><?php echo e($data->price); ?></td>
                    <td class="brand m-auto"><?php echo e($data->rating); ?></td>
                    <td class="brand m-auto"><?php echo e($data->availability); ?></td>                   
                    <td class="center-content h-100">
                        ...
                        <p class="d-none"><?php echo e($data->id); ?></p></a>
...
<script src="<?php echo e(asset('js/functions.js')); ?>" type="module"></script>

<script src="<?php echo e(asset('js/admin-manager.js')); ?>" type="module"></script>

</html><?php /**PATH C:\xampp\htdocs\creedsy\resources\views/admin.blade.php ENDPATH**/ ?>